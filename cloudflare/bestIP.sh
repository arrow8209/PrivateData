...
./CloudflareST -dn 20 -dt 5 -n 50 -allip -f proxy_ip.txt -o result_proxy_ip.csv -url https://download.parallels.com/desktop/v15/15.1.5-47309/ParallelsDesktop-15.1.5-47309.dmg
